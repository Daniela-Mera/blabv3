class TrabajosController < ApplicationController
  ...
  def index
      ...
      #Se reemplaza por
      @trabajos = Empresa.find(current_empresa.id).trabajos  
  end
  ...
  private
    ...
    def trabajo_params
      params.require(:trabajo).permit(:nombre, :cargo, :descripcion, :vacantes, :sueldo, :fecha_inicio, :tipo_id, :regionch_id, :empresa_id)
    end
end
